...
| 항목 | 값 | 상태 |
|------|-----|------|
| **Account SID** | `AC92221a15842adab097c91701b98bc695` | ✅ 확인 |
| **API Key SID** | `SK25178bfe7adf2b2d30c5105096960450` | ✅ 확인 |
| **API Key Secret** | `SKc48cf44beee5f5dab0699c01a14bb10b` | ✅ 확인 |
